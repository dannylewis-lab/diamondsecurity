  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-gray-200 bg-[#fafafa] p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#1d1d1d] mb-3">Have Questions? Let&apos;s Chat!</h2>
              ...
              <a
                ...
                style={{ background: '#3457d5', boxShadow: '0 4px 16px rgba(52,87,213,0.25)' }}
              >
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={title} className="flex items-center gap-4 bg-white rounded-xl border border-gray-100 px-5 py-4">
                  ...
                  <div>
                    <p className="font-semibold text-[#1d1d1d] text-sm">{title}</p>
    ...
    <section className="py-20 bg-white dark:bg-[#050e25]" id="contact">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#1d1d1d] dark:text-white mb-3">Send Us an Inquiry</h2>
